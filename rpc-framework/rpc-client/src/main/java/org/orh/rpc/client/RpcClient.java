...
import org.orh.rpc.common.codec.RpcDecoder;
import org.orh.rpc.common.codec.RpcEncoder;
import org.orh.rpc.registry.ServiceDiscovery;
...
public class RpcClient {
    ...
    private RpcResponse send(RpcRequest request, String host, int port) {
        ...
        try {
            ...
            // 获取 RPC 响应
            return responseMap.get(request.getRequstId());
            ...
            // 移除请求编号与响应对象之间的映射关系
            responseMap.remove(request.getRequstId());
        }
